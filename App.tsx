...
import Page_1 from "./pages/host.$gameCode.tsx";
import PageLayout_1 from "./pages/host.$gameCode.pageLayout.tsx";
import Page_2 from "./pages/game.$gameCode.tsx";
import PageLayout_2 from "./pages/game.$gameCode.pageLayout.tsx";
...
const fileNameToRoute = new Map([["./pages/_index.tsx","/"],["./pages/host.$gameCode.tsx","/host/:gameCode"],["./pages/game.$gameCode.tsx","/game/:gameCode"]]);
const fileNameToComponent = new Map([
    ["./pages/_index.tsx", Page_0],
["./pages/host.$gameCode.tsx", Page_1],
["./pages/game.$gameCode.tsx", Page_2],
  ]);
...
"./pages/host.$gameCode.tsx": PageLayout_1,
"./pages/game.$gameCode.tsx": PageLayout_2,
